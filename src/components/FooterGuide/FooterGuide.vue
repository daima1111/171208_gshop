<template>
  <div>
      <footer class="footer_guide border-1px">
           <a href="javascript:;" class="guide_item" :class="{on:'/msite' === $route.path}" @click="goTo('/miste')">
              <span class="item_icon"> 
                  <i class="iconfont icon-waimai-"></i> 
              </span>
              <span>外卖</span>
              </a>
              <a href="javascript:;" class="guide_item" :class="{on:'/seach' === $route.path}" @click="goTo('/search')"> 
                  <span class="item_icon"> 
